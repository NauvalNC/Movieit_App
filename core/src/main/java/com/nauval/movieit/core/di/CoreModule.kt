package com.nauval.movieit.core.di

import androidx.room.Room
import com.nauval.movieit.core.data.MovieRepository
import com.nauval.movieit.core.data.source.local.LocalDataSource
import com.nauval.movieit.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("nauval".toCharArray())
